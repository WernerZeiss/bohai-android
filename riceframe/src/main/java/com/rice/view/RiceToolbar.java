...
//        }
    ...
    public void initMode() {
        ...
        textBack.setSoundEffectsEnabled(textBack.getVisibility() == View.VISIBLE);
        imgBack.setSoundEffectsEnabled(imgBack.getVisibility() == View.VISIBLE);
        frameBack.setSoundEffectsEnabled(backMode != MODE_HIDE);
        switch (titleMode) {
            case MODE_TEXT:
            case MODE_IMG:
        ...
        textOk.setSoundEffectsEnabled(textOk.getVisibility() == View.VISIBLE);
        imgOk.setSoundEffectsEnabled(imgOk.getVisibility() == View.VISIBLE);
        frameOk.setSoundEffectsEnabled(okMode != MODE_HIDE);
    }
